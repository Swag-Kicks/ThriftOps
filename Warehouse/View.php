...
var settings = {
  "url": "https://sys.thriftops.com/Warehouse/api/addWarehouse.php",
  "method": "POST",
  "timeout": 0,
  "processData": false,
...
var settings = {
  "url": "https://sys.thriftops.com/Warehouse/api/updateStatus.php",
  "method": "POST",
  "timeout": 0,
  "processData": false,
  "mimeType": "multipart/form-data",
...
var settings = {
  "url": "https://sys.thriftops.com/Warehouse/api/updateAlo.php",
  "method": "POST",
  "timeout": 0,
  "processData": false,
  "mimeType": "multipart/form-data",
...
//SHOW VENDORS
       function Vendors(){
        ...
        var settings = {
      "url": "https://sys.thriftops.com/Warehouse/api/vendors.php",
      "method": "POST",
      "timeout": 0,
    };
...
const getSingleRacks = (rid) =>{
    var id = rid
    var settings = {
  "url": "https://sys.thriftops.com/Warehouse/api/getSingleRack.php?id="+id,
  "method": "POST",
  "timeout": 0,
};
...
var settings = {
  "url": "https://sys.thriftops.com/Warehouse/api/updateRack.php",
  "method": "POST",
  "timeout": 0,
  "processData": false,
  "mimeType": "multipart/form-data",
