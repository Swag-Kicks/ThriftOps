...
$sql = "SELECT * FROM `racks` WHERE Warehouse_ID = '8' GROUP By number asc";
...
while ($row = $result->fetch_assoc()) 
{
    ...
    $confirm1 = "SELECT * FROM `racks` where Warehouse_ID='8' AND number='$racknumber'";
    $cap=mysqli_num_rows(mysqli_query($mysql, $confirm1));
    
    $confirm2 = "SELECT * FROM `racks` where Warehouse_ID='8' AND number='$racknumber' AND Status='Empty'";
