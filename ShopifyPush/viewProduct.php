    ...
    <ul class="timelineleft pb-5" id="timeline">
          <li>
            ...
            <div class='timelineleft-item'>
              ...
              <h3 class='timelineleft-header no-border'>Item Price has been edited by Ali Afzal from Rs.2000 to Rs.999.</h3>
            </div>
          </li>
         <li>
            <i class='fa fa-circle '></i>
            <div class='timelineleft-item'>
                 <span class='time'><i class='fa fa-clock-o text-danger'>&nbsp;2023-03-20 11:31:00</i></span>
              <h3 class='timelineleft-header no-border'>Item has been auto-allocated at R1-C3-R8 in Swag Warehouse.</h3>
            </div>
          </li>
         <li>
            <i class='fa fa-circle '></i>
