 ...
 <option value='0'>- Search Brand -</option>
                                               ...
                                               <div class="col-sm-12 row">
                                                   ...
                                                   <div class="col-sm-6">
                                                          ...
                                                          <input class="form-control " type="text" name="made" id="madein"  onchange="iDetails()" aria-describedby="emailHelp" placeholder="Enter Made in">
                                                   </div>
                                               </div>
                                                  ...
                                                  <div class="col-sm-12">
                                                          ...
                                                          <!--<input class="form-control "  type="number" name="SizeEURO"  onchange="SendData()" placeholder="Enter Size">-->
                                                            ...
                                                            <select class="form-control form-select"  name="SizeEURO"  onchange="iDetails()" name="gender">
                                                   <option value=" ">--SELECT EURO SIZE</option>
                           ...
                           <div class="col-sm-12 col-xl-4">
                              <div class="row">
                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <div class="mb-3" >
                                                   <h5>Category</h5>
                                            <select class="form-control form-select  " id="SelectC" name="catID"  onchange="MakeSubcat()"   required>
                                                <option selected="true" disabled="disabled">-SELECT CATEGORY</option></select>
                                             </div>
                            ...
                            <input type="checkbox" id="wcSwitch"><span class="switch-state"></span>
                               ...
                               <h6 class="col-form m-l-10 m-t-10 switchfont">Woocommerce</h6>
                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <div class="mb-3" >
                                                   <h5>Warehouse</h5>
                                               <select class="form-control form-select" name="Warehouse"  id="SelectW" name="warehouse" onchange="getSKU()"   required><option selected="true" disabled="disabled">-SELECT WAREHOUSE</option></select>
                                             </div>
                                                   ...
                                                   <label class="col-form-label pt-0" for="exampleInputEmail1">Rack Location</label>
                                                          <input class="form-control " id="location" type="text" name="location" aria-describedby="emailHelp" placeholder="Enter Location">
                                                              <span id="noteR"></span>
                                             </div>
...
function iDetails(){
 ...
 var titleI = $("input[name=title]").val();
  ...
  document.getElementById('iDetails').innerHTML = `
    ...
    <p>Made in ${made} Imported from USA. Not a fake / Not a first copy / Not a replica. 100% Original & Genuine Product. All are inspected by our team for originality and quality. Easy 7-Day return policy.Please email Contact@swag-kicks.com to initiate return process.</p>
