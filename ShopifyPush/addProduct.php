 ...
 <option value='0'>- Search Brand -</option>
                                               ...
                                               <div class="col-sm-12 row">
                                                  ...
                                                  <div class="col-sm-12">
                                                          ...
                                                          <!--<input class="form-control "  type="text"  name="SizeEURO"  onchange="iDetails()" />-->
                                                            <select class="form-control form-select"  name="SizeEURO"  onchange="iDetails()">
...
function iDetails(){
 ...
 var titleI = $("input[name=title]").val();
   var priceI = $("input[name=price]").val();
    ...
    // var size=document.getElementById("category").value;
