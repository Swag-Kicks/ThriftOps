...
$result123 = mysqli_query($mysql," Select * from Logs Where Type='Product' AND Type_ID='$shopifyid'");
        ...
        while($row1 =mysqli_fetch_assoc($result123))
        {
            ...
            if($status == 'Upload')
            {
                echo "<li>
                    ...
                    <div class='timelineleft-item'>
                        ...
                        <h3 class='timelineleft-header no-border'><a>● product:</a> <span class='text-muted'><b>$sku</b> has been uploaded</span></h3>
                    </div>
                </li>";
            }
            //confirmed
          else if($status == 'draft')
            {
                echo "<li>
                    ...
                    <div class='timelineleft-item'>
                        <span class='time'><i class='fa fa-clock-o text-danger'>&nbsp;</i>$datetime</span>
                        <h3 class='timelineleft-header no-border'><a>● Order</a> <span class='text-muted'><b>$sku</b> has been Confirmed by $name</span></h3>
                    </div>
                </li>";
            }
            ...
            else if($status == 'active')
            {
                echo "<li>
                    ...
                    <div class='timelineleft-item'>
                        <span class='time'><i class='fa fa-clock-o text-danger'>&nbsp;</i>$datetime</span>
                        <h3 class='timelineleft-header no-border'><a>● Order</a> <span class='text-muted'><b>$sku</b> has been Cancel by $name</span></h3>
                    </div>
                </li>";
            }
            //booked
