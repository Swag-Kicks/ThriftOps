...
<script>
   function typeAll(){
       ...
       var settings = {
     "url": "https://sys.thriftops.com/Vendor2/api/all.php",
     "method": "GET",
     "timeout": 0,
   };
                           ...
                           <tr>
                                ...
                                <td style="text-align: center;">${values.Warehouse_ID}</td>
                                 <td style="text-align: center;">${values.Fments}</td>
                                   ...
                                   <td style="text-align: center;"><a href="#" data-role="view" ><img class="icons" onclick="viewVendor(${values.Vendor_ID})"  src="https://sys.thriftops.com/assets/images/icons/eye.png"></a>
   ...
   function typeSeller(){
       ...
       var settings = {
     "url": "https://sys.thriftops.com/Vendor2/api/vendorType.php?type=Seller",
     "method": "GET",
     "timeout": 0,
   };
   ...
   function typePeer(){
       ...
       var settings = {
     "url": "https://sys.thriftops.com/Vendor2/api/vendorType.php?type=Peer",
     "method": "GET",
     "timeout": 0,
   };
   ...
   function typeSupplier(){
       ...
       var settings = {
     "url": "https://sys.thriftops.com/Vendor2/api/vendorType.php?type=Supplier",
     "method": "GET",
     "timeout": 0,
   };
...
<script>
   ...
   var settings = {
   "url": "https://sys.thriftops.com/Vendor2/api/lastVid.php",
   "method": "POST",
   "timeout": 0,
   };
   ...
   var settings = {
   "url": "https://sys.thriftops.com/Vendor2/api/banksAdd.php",
   "method": "POST",
   "timeout": 0,
   "processData": false,
   ...
   var settings = {
   "url": "https://sys.thriftops.com/Vendor2/api/vendorAdd.php",
   "method": "POST",
   "timeout": 0,
   "processData": false,
   "mimeType": "multipart/form-data",
   ...
   var settings = {
   "url": "https://sys.thriftops.com/Vendor2/api/addUser.php",
   "method": "POST",
   "timeout": 0,
   "processData": false,
   "mimeType": "multipart/form-data",
   ...
   var name = $("input[name=name]").val();
       ...
       var settings = {
   "url": "https://sys.thriftops.com/Vendor2/api/nCheck.php?colmn=Name&name="+name,
   "method": "POST",
   "timeout": 0,
   };
   ...
   function skuCheck(){
       ...
       var settings = {
   "url": "https://sys.thriftops.com/Vendor2/api/nCheck.php?colmn=SK_Prefix&name="+SKU,
   "method": "POST",
   "timeout": 0,
   };
   ...
   var settings = {
   "url": "https://sys.thriftops.com/Vendor2/api/viewVendor.php?id="+value,
   "method": "POST",
   "timeout": 0,
   };
   ...
   var settings = {
   "url": "https://sys.thriftops.com/Vendor2/api/editVendor.php?id="+vid,
   "method": "POST",
   "timeout": 0,
   "processData": false,
   "mimeType": "multipart/form-data",
