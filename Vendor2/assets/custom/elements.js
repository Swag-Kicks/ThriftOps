...
<div class="col-md-8">
    <select class="form-control  " name="gender" id="category_id"  required>
...
<div class="col-md-8">
    <input type="text" class="form-control" name="sizeLabel" placeholder="Size on Label ">
</div>
</div>`;
...
<div class="col-md-8">
    <select class="form-control  " name="collar" id="category_id"  required>
...
<div class="col-md-8">
    <select class="form-control  " name="sleeveStyle" id="category_id"  required>
...
<div class="col-md-8">
    <select class="form-control  " name="fitType" id="category_id"  required>
...
<div class="col-md-8">
    <select class="form-control  " name="sleeveType" id="category_id"  required>
      <option value="">Select Fit Type</option>
...
<div class="col-md-8">
    <input type="number" class="form-control" name="chest" placeholder="Chest(P2P) ">
</div>
</div>`;
...
<label class="col-md-3 col-from-label">Sleeve Length</label>
<div class="col-md-8">
    <select class="form-control  " name="sleeveLength" id="category_id"  required>
      <option value="">Select Fit Type</option>
                                            <option value="Short Sleeve">Short Sleeve</option>
                                            <option value="Full Sleeves">Full Sleeves</option>
                                            <option value="Wide/loose">Wide/loose</option> </select>
...
<div class="col-md-8">
    <select class="form-control  " name="neckStyle" id="category_id"  required>
...
<div class="col-md-8">
    <select class="form-control  " name="hoodieType" id="category_id"  required>
...
<div class="col-md-8">
    <select class="form-control  " name="sleeveSize" id="category_id"  required>
...
<div class="col-md-8">
    <select class="form-control  " name="jacketType" id="category_id"  required>
      <option value="">Select Type</option>
...
<div class="col-md-8">
    <input type="number" class="form-control" name="waist" placeholder="Waist in Inches ">
</div>
</div>`;
...
<div class="col-md-8">
    <input type="text" class="form-control" name="name" placeholder="Inseam ">
</div>
</div>`;
...
<div class="col-md-8">
    <select class="form-control  " name="rise" id="category_id"  required>
...
<label class="col-md-3 col-from-label">Fit Type</label>
<div class="col-md-8">
    <select class="form-control  " name="jeansFitType" id="category_id"  required>
      <option value="">Select Fit Type</option>
...
<label class="col-md-3 col-from-label">Type</label>
<div class="col-md-8">
    <select class="form-control  " name="jeansType" id="category_id"  required>
      <option value="">Select Type</option>
...
<div class="col-md-8">
    <select class="form-control  " name="trackNeck" id="category_id"  required>
...
<label class="col-md-3 col-from-label">Neck Style</label>
<div class="col-md-8">
    <select class="form-control  " name="romperNeck" id="category_id"  required>
      <option value="">Select Neck Style</option>
...
<label class="col-md-3 col-from-label">Type</label>
<div class="col-md-8">
    <select class="form-control  " name="dressType" id="category_id"  required>
      <option value="">Select Type</option>
...
<label class="col-md-3 col-from-label">Type</label>
<div class="col-md-8">
    <select class="form-control  " name="sneakerType" id="category_id"  required>
      <option value="">Select type</option>
...
<div class="col-md-8">
    <input type="text" class="form-control" name="heelSize" placeholder="Heel Size ">
</div>
</div>`
...
<select class="form-control  " name="heelType" id="category_id"  required>
...
<label class="col-md-3 col-from-label">Type</label>
<div class="col-md-8">
    <select class="form-control  " name="watchType" id="category_id"  required>
      <option value="">Select type</option>
...
<div class="col-md-8">
    <select class="form-control  " name="headConnect" id="category_id"  required>
...
<label class="col-md-3 col-from-label">Type</label>
<div class="col-md-8">
    <select class="form-control  " name="headType" id="category_id"  required>
      <option value="">Select type</option>
...
<div class="col-md-8">
    <select class="form-control  " name="tiePattern" id="category_id"  required>
...
<label class="col-md-3 col-from-label">Type</label>
<div class="col-md-8">
    <select class="form-control  " name="tietype" id="category_id"  required>
      <option value="">Select type</option>
...
<label class="col-md-3 col-from-label">Type</label>
<div class="col-md-8">
    <select class="form-control  " name="socksType" id="category_id"  required>
      <option value="">Select type</option>
                                            <option value="Casual">Casual</option>
...
<label class="col-md-3 col-from-label">Length</label>
<div class="col-md-8">
    <select class="form-control  " name="socksLength" id="category_id"  required>
...
<label class="col-md-3 col-from-label">Pattern</label>
<div class="col-md-8">
    <select class="form-control  " name="scarfPattern" id="category_id"  required>
      <option value="">Select Pattern</option>
                                            <option value="Solid">Solid</option>
                                            <option value="Printed">Printed</option>
...
//   detailDiv.style.backgroundColor="#F6F2F2";
...
console.log()
   ...
   <li><b>Made in: </b>${made}</li>
    ...
    <li><b>Collar: </b>${collarI}</li>
     ...
     <h2>Size <a href='https://www.swag-kicks.com/pages/size-chart'><h4>(View Size Chart)</h4></a></h2>
    <br/>
       ${ul1}
...
function ShopifyPush(d1,d2,d3){
 var form = new FormData();
form.append("title", d1);
form.append("desc", d2);
form.append("price", d3);

var settings = {
  "url": "https://developer.thriftops.com/dontdelete/addproduct/shopify.php",
  "method": "POST",
  "timeout": 0,
  "processData": false,
