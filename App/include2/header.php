...
<html lang="en">
      ...
      <div class="page-main-header">
        <div class="main-header-right row m-0">
          <div class="main-header-left">
            <div class="logo-wrapper" ><a href="../Dashboard/Home"><img class="img-fluid" src="../assets/images/logo-b.png" style="width: 160px;" alt=""></a></div>
  ...
  if(sessionId == '') {
    window.location.href = '../include/session';
  } else {
