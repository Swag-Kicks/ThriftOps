          ...
          <ul class="nav-menu custom-scrollbar p-t-20"  id="myTab">
            ...
            <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><span>Products</span></a>
              <ul class="nav-submenu menu-content">
                ...
                <li><a href="../ShopifyPush/addAttribute">Add Category</a></li>
                <!--<li><a href="../ShopifyPush/addProduct">Add Product</a></li>-->
                <li><a href="https://backup.thriftops.com/ShopifyPush/addProduct">Product Listing</a></li>
            ...
            <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><span>Returns</span></a>
              <ul class="nav-submenu menu-content">
                <li><a href="https://backup.thriftops.com/Return/return">All Return</a></li>
                <li><a href="https://backup.thriftops.com/Return/recieve">Returning Items</a></li>
...
$.ajax(settings).done(function (response) {
 ...
 if (response == 1) {
  ...
  purchaseRequestsLink.href = '../PR/PR_Admin';
}
