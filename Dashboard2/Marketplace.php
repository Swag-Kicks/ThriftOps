<?php 
    ...
    $categoryNameQuery = "SELECT Category as cat ,Query as query FROM AnalyticsMP";
...
<form action="" method="POST" class="PR">
  ...
  <h1 style="margin-left: 376px;top: 32px;position: relative;">Marketplace Sold Items Report</h1>
  <div class="row">
    <div class="col-md-12">
      <!--<label>-->
    ...
    ?> 
      ...
      <h1 style="margin-left: 376px;top: 32px;position: relative;">Uploaded Items Report</h1>

    </div>
  </div>
</form> <?php include ("footer.php"); ?> </body>
</html>