...
if(!empty($_POST["id"]) && !empty($_POST["courierstat"]) &&!empty($_POST["order"]) && !empty($_POST["name"]) && !empty($_POST["address"]) && !empty($_POST["contact"]) && !empty($_POST["total"]) && !empty($_POST["city"])&& !empty($_POST["weight"])&& !empty($_POST["items"])&& !empty($_POST["dispatch_advise"]))
{
    ...
    if($courier=='PostEx')
    {
         ...
         if(!empty($num))
        {
            ...
            $las="UPDATE `Order` SET Tracking='$num',Courier='PostEx',Status='Rebooked' WHERE Order_ID='$id'";
            $relt1 = mysqli_query($mysql, $las);
            
            //logs
            $sql1 = "INSERT INTO Logs (User_ID,Type,Type_ID,Status,DateTime) VALUES ('$cr','Order','$order', 'Rebooked', '$C_Date')";
    ...
    if($courier=='Leopard')
    {
        ...
        {
            //status update database
            $las="UPDATE `Order` SET Tracking='$num',Pdf_link='$link',Courier='Leopard',Status='Rebooked' WHERE Order_ID='$id'";
            $relt1 = mysqli_query($mysql, $las);
    ...
    if($courier=='Trax')
    {
        ...
        {
           //status update database
            $las="UPDATE `Order` SET Tracking='$num',Courier='Trax',Status='Rebooked' WHERE Order_ID='$id'";
            $relt1 = mysqli_query($mysql, $las);
    ...
    if($courier=='Rider')
    {
        ...
        {
            //status update database
            $las="UPDATE `Order` SET Tracking='$num',Courier='Rider',Status='Rebooked' WHERE Order_ID='$id'";
            $relt1 = mysqli_query($mysql, $las);
    ...
    if($courier=='CallCourier')
    {
        ...
        {
            //status update database
            $las="UPDATE `Order` SET Tracking='$num',Courier='CallCourier',Status='Rebooked' WHERE Order_ID='$id'";
            $relt1 = mysqli_query($mysql, $las);
    ...
    if($courier=='Self')
    {
        ...
        {
            //status update database
            $las="UPDATE `Order` SET Tracking='$tt',Courier='Self',Status='Rebooked' WHERE Order_ID='$id'";
            $relt1 = mysqli_query($mysql, $las);
