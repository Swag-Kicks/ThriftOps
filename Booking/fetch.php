    ...
    if($cond=="all")
    {
        if($_POST['from']!= '')
        {
             if($_POST['to'] != '')
             {
                 if($_POST['courier'] != '')
                 {
                     $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Status in ("Confirmed","Exchange","Dispatched","InTransit","Delivered","Returned","Loss","Booked",") AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                 }
                 if($_POST['courier'] == '')
                 {
                    $query .= ' WHERE Status in ("Confirmed","Exchange","Dispatched","InTransit","Delivered","Returned","Loss","Booked",") AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                 }
             }
        }
    ...
    if($cond=="Booked")
    {
        if(!empty($_POST['from']))
        {
             if(!empty($_POST['to']))
             {
                 if($_POST['courier'] != '')
                 {
                     $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Courier !="" AND Tracking !="" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                 }
                //  if($_POST['courier'] == '')
                //  {
                //     $query .= ' WHERE Courier !="" AND Tracking !="" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                //  }
             }
        }
        if($_POST['courier'] != ''  && $_POST['from'] == '' && $_POST['to'] == '')
