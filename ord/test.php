...
$Total=$row['Total'];
$adjust=$row['Adjusment_Reason'];


$res5 = mysqli_query($mysql, "SELECT SUM(Price*Quantity) as tot FROM `Order` WHERE Order_ID='$id'");
                            ...
                            <label class="col-md-3 col-from-label">Shipping</label>
                             <div class="col-md-5 f-center" style="text-align: center;">
                                <select class="mx-auto w-50 form-select text-center mb-2" id="shipi">
                                    ...
                                    if($Shipping==0)
                                    {
                                        echo '<option value="freedel" selected>Free Delivery</option>";
                                         <option value="standel">Standard Delivery</option>
                                        <option value="cusdel">Custom Delivery</option>';
                                    }
                                    if($Shipping==250)
                                    {
                                        echo '<option value="freedel" >Free Delivery</option>";
                                         <option value="standel" selected>Standard Delivery</option>
                                        <option value="cusdel">Custom Delivery</option>';
                                    }
                                    // else
                                    // {
                               ...
                               <select class="mx-auto w-50 form-select text-center mb-2" id="reason">
                                    ...
                                    else if($adjust=='cusdel')
                                    {
                                        echo '<option value="">Select</option>
                                            <option value="Adjustment">Adjustment</option>
                                            <option value="Exchange">Exchange</option>
                                            <option value="cusdel" selected>Custom</option>
                                            <option value="Employee">Employee</option>
                                            <option value="Giveaway">Giveaway</option>
                                            <option value="Influencer">Influencer</option>
                                            <option value="Shopify">Shopify</option>';
                                    ...
                                    else if($adjust=='Giveaway')
                                    {
                                        echo '<option value="">Select</option>
                                            ...
                                            <option value="cusdel">Custom</option>
                                            <option value="Employee">Employee</option>
                                            <option value="Giveaway" selected>Giveaway</option>
                                            <option value="Influencer">Influencer</option>
                                            <option value="Shopify">Shopify</option>';
                                    }
