...
if(isset($_POST['cond']))
{
    ...
    if($cond=="all")
    {
        if(!empty($_POST['from']))
        {
             if(!empty($_POST['to']))
             {
                $query .= ' WHERE Status in ("None","Confirmed","Cancel","Hold","Reattempt","WFR") AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
             }
        }
        else
        {
    ...
    if($cond=="Pending")
    {
        if(!empty($_POST['from']))
        {
             if(!empty($_POST['to']))
             {
                 $query .= ' WHERE Status LIKE "%None%" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
             }
        }
        else
        {
...
while($row = mysqli_fetch_array($result))
{
    ...
    <tr>
      ...
      <div class="btn-group align-top">
                                        <select class="mark" name="'.$row["Order_ID"].'" id="mark">
                                          <option disabled selected>
                                          </option>
                                          <option value="Confirmed">Confirm</option>
                                          <option value="Hold">Hold</option>
                                          <option value="Cancel">Cancel</option>
                                          <option value="Wfr">Wait for Return</option>
                                        </select>
        </td>
         <td class="align-middle text-center">
      <div class="btn-group align-top">
                                            <a href="Order_View.php?GETID='.$row["Order_ID"].'" target="_blank" data-role="prview" data-id="'.$row["Order_ID"].'"><img class="icons" src="../assets/images/icons/eye.png"></a>
