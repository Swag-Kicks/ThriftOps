...
if(!empty($_POST['ordernum']))
{
    ...
    if(is_numeric($cut))
    {
        $query .= ' WHERE Order_Number LIKE "%#'.str_replace(' ', '%', $_POST['ordernum']).'%" AND Status="Dispatched" AND City LIKE "%Kar%" AND Courier="Self" AND Date > 2023-12-20';
    }
    else
    {
       $query .= ' WHERE Order_Number LIKE "%'.str_replace(' ', '%', $_POST['ordernum']).'%" AND Status="Dispatched" AND City LIKE "%Kar%"  AND Courier="Self" AND Date > 2023-12-20';
...
{
    $query .= ' Where Status="Dispatched" AND City LIKE "%Kar%" AND Courier="Self" AND Date > 2023-12-20';
}
