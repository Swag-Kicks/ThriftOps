...
if(isset($_POST['submit']))
{
  ...
  else
  {
    ...
    echo '<script>window.location.href="https://sys.thriftops.com/rider.php";</script>';
  }
          ...
          <div class="col-xl-12 p-0">  
            ...
            <div class="login-card">
              ...
              <form class="theme-form login-form" role="form" id='login' action="" method='post' accept-charset='UTF-8'>
                  <a href="../index"><img class="img-fluid" src="../assets/images/logo-b.png" style="width: 228px;margin-bottom: 45px; image-rendering: -webkit-optimize-contrast;" alt=""></a>
                <h4>Login</h4>
                <br>
