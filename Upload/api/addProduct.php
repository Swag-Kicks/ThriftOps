...
// $Inventory_Status=$_POST['Inventory_Status'];
    ...
    //   );";
       ...
       $result2= mysqli_query($mysql,"Update `addition` Set Weight='$weight',Brand='$brand',Made='$made ',Material='$material',Gender='$gender',Code='$code',Status='$status',Price='$price',DateTime='$C_Date',Category_ID='$Category',Sub_Category_ID='$SubCat',Quantity='$qty',Color='$color' Where SKU='$sku'");
