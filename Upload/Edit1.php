...
$Genderid=$row['Gender'];
$genderid === 1 ? "Male": $genderid === 2 ? "Unisex": $genderid === 3 ?  "Kids": "Female";
$Code=$row['Code'];
                              ...
                              <div class="card-body">
                                 <form class="theme-form">
                                    <div class="mb-3">
                                       ...
                                       <input class="form-control " id="title" type="title"  name="title" value="<?php echo $Title ?>">
                                    </div>
                                    <div class="col-sm-12 row">
                                       <div class="col-sm-6">
                                          <div class="mb-3">
                                             <label class="col-form-label pt-0">Condition</label>
                                             <select class="form-control form-select  " name="condition"  id="condition_id">
                                                <option Selected value="<?php echo $Cndition ?>"><?php echo $Cndition ?></option>
                                       ...
                                       <div class="col-sm-6">
                                          <div class="mb-3">
                                             ...
                                             <select id='selUser' name="brand"  class="form-control form-select " >
                                                <option Selected value="<?php echo $brandid  ?>"><?php echo $Brand ?></option>
                                             </select>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-sm-12 row">
                                       ...
                                       <div class="col-sm-6">
                                          ...
                                          <input class="form-control " type="text" name="made" id="madein"  aria-describedby="emailHelp" value="<?php echo $Made ?>">
                                       </div>
                                    </div>
                                    <div class="col-sm-12 row">
                                       <div class="col-sm-6">
                                          <label class="col-form-label pt-0" >Material</label>
                                          <input class="form-control "  type="text" name="material" value="<?php echo $Material  ?>">
                                       </div>
                                       <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-12 row">
                                       ...
                                       <div class="col-sm-6">
                                          ...
                                          <select class="form-control form-select" name="gender">
                                             <option value="<?php echo $genderid  ?>"><?php echo $genderid  ?></option>
                                    ...
                                    <div class="col-sm-12 row">
                                        <div class="col-sm-6">
                                            <label class="col-form-label pt-0" >Size</label>
                                             ...
                                             <select class="form-control form-select"  name="SizeEURO"  name="gender">
                                        ...
                                        <div class="col-sm-6">
                                          ...
                                          <input class="form-control " id="pcode" type="text" name="pcode"  value="<?php echo $Code ?>">
                                       </div>
                                    </div>
                              </div>
                              </form>
                           ...
                           <form action="upload.php" enctype="multipart/form-data" class="dropzone" id="image-upload">
                              <div>
                                 <ul id="sortUl"  class="drag-sort-enable ulS" style="display: block;">
                                    <li id="1li" class="imgLI"><img  id="img1" class="productImage" src="<?php echo $Image_1; ?>" /><button class="btn-close clz" type="button" aria-label="Close" onclick="deleteImg('1li')" onchange="button();"></button></li>
                        ...
                        <div  class="col-sm-12">
                           <div class="card cardshadow">
                              <div class="card-body">
                                 <div class="mb-3" >
                                    <h5>Category</h5>
                                    <select class="form-control form-select  " id="SelectC" name="catID"  onload="MakeSubcat();"  onchange="MakeSubcat();button();" required>
...
$(document).on('load', '#SelectC', function(){
//   $("#SelectC").load(function(){
    console.log("value");
  });
});
</script>
