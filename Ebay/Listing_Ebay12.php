                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 " style="margin-bottom: 20px;">
                            ...
                            <div class="form-group mb-0 buttonIn">
                                ...
                                <input type="text" class="form-control" name="category_fetch" id="category_fetch" placeholder=" Enter Query to get specific Categories " onChange="myFunction()">
                ...
                <div class="card-body">
                    <div class="">
                       ...
                       <!--<input value="Add to preview"  type="button" onclick="formdataa()" id="btn">-->
                            ...
                            <div class="" >
                                <button name="submit" value="Submit" class="btn btn-primary btn-block f-right">Lets Add</button>
                            </div>
                        </div>
                    </div>
                </div>
