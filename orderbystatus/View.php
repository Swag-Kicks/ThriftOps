...
<div class="page-body">
   <div class="container-fluid">
      <div class="page-header">
         <div class="row">
          <div class="col-md-4">
              <h3 class=" modal-title">Orders by status report</h3>
      ...
      <div class="row project-cards">
       ...
       <div class="row" style="background-color:#F9FCFF;margin:0.8px;height:100px;">
              ...
              <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                      ...
                      <li class="nav-item"><a class="nav-link" id="pen_ord" data-bs-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="false">Confirmed <span id="pendingc"></span></a></li>
                      <li class="nav-item"><a class="nav-link" id="conf_ord" data-bs-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false">Cancelled <span id="confirmc"></span> </a></li>
                      <li class="nav-item"><a class="nav-link" id="can_ord" data-bs-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false">On-Hold<span id="cancelc"></span> </a></li>
                      <li class="nav-item"><a class="nav-link" id="hold_ord" data-bs-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false">Picked<span id="holdc"></span> </a></li>
                      <li class="nav-item"><a class="nav-link" id="re_ord" data-bs-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false">Not Found<span id="reatemptc"></span></a></li>
                      <li class="nav-item"><a class="nav-link" id="qc_ord" data-bs-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false">Qc Reject<span id="qcc"></span></a></li>
                      <li class="nav-item"><a class="nav-link" id="wait_ord" data-bs-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false">Packed<span id="waitforretc"></span></a></li>
                       <li class="nav-item"><a class="nav-link" id="dis_ord" data-bs-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false">Dispatch<span id="distc"></span></a></li>
            ...
            $.ajax({
                    ...
                    data:{from:from,to:to},
                     success:function(response)
                     {
                        ...
                        $('#pendingc').html('('+conf+')');
                        $('#confirmc').html('('+cancel+')');
                        $('#cancelc').html('('+hold+')');
                        $('#holdc').html('('+picked+')');
                        $('#reatemptc').html('('+notf+')');
                        $('#qcc').html('('+qc+')');
                        $('#waitforretc').html('('+packed+')');
                        $('#distc').html('('+dispatc+')');
                        $('#allc').html('('+all+')');
