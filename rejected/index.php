...
<div class="page-body">
   <div class="container-fluid">
      <div class="page-header">
         <div class="row">
          <div class="col-md-4">
              <h3 class=" modal-title">Receive List</h3>
      ...
      <div class="row project-cards">
            ...
            <div class="card">
               <div class="table-responsive">
                ...
                <div class="col-md-6 " style="margin-top:34px;" id="currentbutton">
                    <a href="#" id="all_ord" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" class="btn btn-primary-light curent">QC-Rejected</a>
        ...
        <table class="dataTable no-footer" role="grid" style="margin-left: 0px; width: 1787.12px;">
          ...
          <th class="res" tabindex="0" aria-controls="example" rowspan="1" colspan="1"  aria-sort="ascending" >#Sno
            ...
            <th class="res" tabindex="0" aria-controls="example" rowspan="1" colspan="1">Order Number
            	<br>
...
function JSDropDown() {
        ...
        function enable()
    {
        $('#all_ord').addClass('curent');
        $('#dis_ord').removeClass("curent");
        $('#conf_ord').removeClass("curent");
        $('#pack_ord').removeClass("curent");
  ...
  $(document).ready(function(){
    ...
    $(document).on('click', '.page-link', function()
    {
      ...
      //packed
      $(document).on('click', '#pack_ord', function(){
          cond='Pack';
          load_data(page,ordernum,limit,sort,from,to,items,cond);
      });
