...
if(isset($_POST['submit']) && isset($_POST['dis']) && isset($_POST['camp']))
{
    $camp=$_POST['camp'];
    //echo $camp;
   // echo "Price: ".$pr;
   ...
   //echo "Final: ".$tot;
    ...
    $up="UPDATE orders SET Total_Amount='$tot',Giveaway='$camp',Updated_By='$user',Updated_By_Time='$C_Date' WHERE order_id='$ID'";
...
<?php include ("../include/header.php"); ?>
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0 card-title">Giveaway</h3>
                </div>
		        <form action="" method="POST" class="PR">
                    ...
                    <div class="row">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="camp"  placeholder="Enter Campaign Name" required>
                         </div> 
                      ...
                      <div class="col-md-12">
                         <button class="btn btn-primary btn-block" name="submit">Update Giveaway 👉</button>
                      </div>
                   </div>
		        </form>
	       </div>
