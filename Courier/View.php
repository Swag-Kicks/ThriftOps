...
<div class="page-body">
   <div class="container-fluid">
      <div class="page-header">
         <div class="row">
          <div class="col-md-4">
              <h3 class=" modal-title"> Courier Status</h3>
      ...
      <div class="row project-cards">
       ...
       <div class="row" style="background-color:#F9FCFF;margin:0.8px;height:100px;">
              ...
              <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                      ...
                      <li class="nav-item"><a class="nav-link" id="ret_ord" data-bs-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false">Courier Returned<span id="returnedb"></span></a></li>
                      <li class="nav-item"><a class="nav-link" id="loss_ord" data-bs-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false">Customer Return<span id="lostb"></span></a></li>
