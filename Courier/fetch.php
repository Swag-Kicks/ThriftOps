    ...
    if($cond=="all")
    {
        if($_POST['from']!= '')
        {
             if($_POST['to'] != '')
             {
                 if($_POST['courier'] != '')
                 {
                     $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'" AND Status in ("Confirmed","Dispatched","Delivered","CReturned","Returned","Booked","Intransit")';
                 }
                 if($_POST['courier'] == '')
                 {
                    $query .= ' WHERE Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'" AND Status in ("Confirmed","Dispatched","Delivered","CReturned","Returned","Booked","Intransit")';
                 }
             }
        }
        if($_POST['courier'] != '' && $_POST['from'] == '' && $_POST['to'] == '')
        {
          $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Status in ("Confirmed","Dispatched","Delivered","CReturned","Returned","Booked","Intransit")';
        }
        if($_POST['courier'] == '' && $_POST['from'] == '' && $_POST['to'] == '')
        {
            $query .= ' WHERE Status in ("Confirmed","Dispatched","Delivered","CReturned","Returned","Booked","Intransit")';
        }
    ...
    if($cond=="Confirmed")
    {
        if(!empty($_POST['from']))
        {
             if(!empty($_POST['to']))
             {
                 if($_POST['courier'] != '')
                 {
                     $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Status ="'.$_POST['cond'].'" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                 }
                 if($_POST['courier'] == '')
                 {
                    $query .= ' WHERE Status ="'.$_POST['cond'].'" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                 }
             }
        }
        if($_POST['courier'] != '' && $_POST['from'] == '' && $_POST['to'] == '')
        {
          $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Status="'.$_POST['cond'].'" ';
        }
        if($_POST['courier'] == '' && $_POST['from'] == '' && $_POST['to'] == '')
        {
           $query .= ' WHERE Status ="'.$_POST['cond'].'" ';
        }
    }
    if($cond=="Dispatched")
    {
    ...
    if($cond=="Intransit")
    {
        if(!empty($_POST['from']))
        {
             if(!empty($_POST['to']))
             {
                 if($_POST['courier'] != '')
                 {
                     $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Status="Intransit" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                 }
                 if($_POST['courier'] == '')
                 {
                    $query .= ' WHERE Status="Intransit" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                 }
             }
        }
        if($_POST['courier'] != ''  && $_POST['from'] == '' && $_POST['to'] == '')
        {
          $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Status="Intransit" ';
        }
        if($_POST['courier'] == '' && $_POST['from'] == '' && $_POST['to'] == '')
        {
    ...
    if($cond=="Loss")
    {
        if(!empty($_POST['from']))
        {
             if(!empty($_POST['to']))
             {
                 if($_POST['courier'] != '')
                 {
                     $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Status="Returned" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                 }
                 if($_POST['courier'] == '')
                 {
                    $query .= ' WHERE Status= "Returned" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                 }
             }
        }
        if($_POST['courier'] != ''  && $_POST['from'] == '' && $_POST['to'] == '')
        {
          $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Status="Returned"';
        }
        if($_POST['courier'] == '' && $_POST['from'] == '' && $_POST['to'] == '')
        {
    ...
    if($cond=="Booked")
    {
        if(!empty($_POST['from']))
        {
             if(!empty($_POST['to']))
             {
                 if($_POST['courier'] != '')
                 {
                     $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Courier !="" AND Tracking !="" AND Status="Booked" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                 }
                 if($_POST['courier'] == '')
                 {
                    $query .= ' WHERE Courier !="" AND Tracking !="" AND Status="Booked" AND Date Between "'.$_POST['from'].'" AND "'.$_POST['to'].'"';
                 }
             }
        }
        else if($_POST['courier'] != ''  && $_POST['from'] == '' && $_POST['to'] == '')
        {
          $query .= ' WHERE Courier LIKE "%'.str_replace(' ', '%', $_POST['courier']).'%" AND Courier !="" AND Tracking !="" AND Status="Booked"';
        }
        else if($_POST['courier'] == '' && $_POST['from'] == '' && $_POST['to'] == '')
        {
            $query .= ' WHERE Courier !="" AND Tracking !="" AND Status="Booked"';
        }
    }
