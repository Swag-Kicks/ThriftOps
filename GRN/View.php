...
if(isset($_POST["id"]))
{
    ...
    $result1qw = mysqli_query($mysql, "SELECT * from GRN WHERE GRN_ID='$fsi'");
    $row123 = mysqli_fetch_assoc($result1qw);
    $id=$row123['PO_ID'];
    $Delive=$row123['Delivered_By'];
    $conta=$row123['Delivered_Contact'];
    $count=1;
        ...
        else
        {
            ...
            $output = '  
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="Pon f-18">Good Recieved Note #&nbsp;<lable style="font-weight: bold;">'.$fsi.'</label></label><br>
                   ...
                   <div class="col-md-6 f-right t-r" >
                    ...
                    <table class="table table-striped">
                      ...
                      <tr class="text-center">
                            ...
                            <td scope="col">Orignal Quantity</td>
                            <td scope="col">Received Quantity</td>
