       ...
       <div class="row mt-3">
          <div class="col-md-8">
              <h3 class=" modal-title">Receive Articles</h3>
                ...
                <a href="#" id="newupload" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" class="btn btn-primary-light curent" >Newly Uploaded</a>
              ...
              <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                ...
                <div class="col-md-4 p-r-20" style="margin-top:30px;">
                  ...
                  <div class="bookmark">
                    <ul>
                            <li>
                                <select class="class='form-control form-select form-control-secondary f-left'" id="allmark">
        ...
        setInterval(function () 
                  {
                        ...
                        $(document).on('click', '#ref', function()
                    {
                        ...
                        var bul=document.getElementById("allmark").value='1';
                        // var all1=document.getElementById("all_ord").value='';
                        // var pen1=document.getElementById("pen_ord").value='';
                        // var mark1=document.getElementById("conf_ord").value='';
                        
                        
                        var all2=document.getElementById("pendingc").value='';
                        var pen2=document.getElementById("confirmc").value='';
                        var mark2=document.getElementById("allc").value='';
                            ...
                            else
                            {
                                $.ajax({
                                    ...
                                    success:function()
                                    {
                                        ...
                                        var cond="all";
                                         document.getElementById("allmark").value='1';
