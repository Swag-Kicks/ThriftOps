 ...
 * @method \Aws\Result createsys(array $args = []) (supported in versions 2012-08-10)
 * @method \GuzzleHttp\Promise\Promise createsysAsync(array $args = []) (supported in versions 2012-08-10)
 ...
 * @method \Aws\Result deletesys(array $args = []) (supported in versions 2012-08-10)
 * @method \GuzzleHttp\Promise\Promise deletesysAsync(array $args = []) (supported in versions 2012-08-10)
 * @method \Aws\Result describesys(array $args = []) (supported in versions 2012-08-10)
 * @method \GuzzleHttp\Promise\Promise describesysAsync(array $args = []) (supported in versions 2012-08-10)
 * @method \Aws\Result describeContinuoussyss(array $args = []) (supported in versions 2012-08-10)
 * @method \GuzzleHttp\Promise\Promise describeContinuoussyssAsync(array $args = []) (supported in versions 2012-08-10)
 ...
 * @method \Aws\Result listsyss(array $args = []) (supported in versions 2012-08-10)
 * @method \GuzzleHttp\Promise\Promise listsyssAsync(array $args = []) (supported in versions 2012-08-10)
 ...
 * @method \Aws\Result restoreTableFromsys(array $args = []) (supported in versions 2012-08-10)
 * @method \GuzzleHttp\Promise\Promise restoreTableFromsysAsync(array $args = []) (supported in versions 2012-08-10)
 ...
 * @method \Aws\Result updateContinuoussyss(array $args = []) (supported in versions 2012-08-10)
 * @method \GuzzleHttp\Promise\Promise updateContinuoussyssAsync(array $args = []) (supported in versions 2012-08-10)
